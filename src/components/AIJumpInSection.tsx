    ...
    <section className="bg-[#0d0d0d] px-6 py-28 lg:px-10">
      <div className="mx-auto max-w-[1300px]">
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-[1.3fr_1fr]">
          <div className="rounded-3xl bg-[#161616] p-8">
            <div className="mb-6 flex items-center gap-2 text-white/70">
              ...
              <h3 className="text-xl font-semibold text-white">Your episode&rsquo;s ready</h3>
            </div>
            <p className="max-w-md text-[15px] leading-relaxed text-white/60">
              Riverside&rsquo;s AI turns your session into a polished cut complete with
              transcripts, show notes, and more. Edit further if you&rsquo;d like, or share as
              is.
            </p>
          ...
          <div className="rounded-3xl bg-[#161616] p-8">
            <p className="mb-4 text-sm font-semibold text-white/50">Magic clips</p>
            ...
            <p className="mt-6 text-sm leading-relaxed text-white/60">
              ...
              Our AI Co-Creator makes a full suite of promotional assets instantly, optimized for
              each channel so you can reach more of your audience.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl bg-[#161616] p-8">
            <h3 className="mb-2 font-heading text-2xl font-medium text-white">
              Hours of editing, done in seconds.
            </h3>
            <p className="mb-6 max-w-md text-sm leading-relaxed text-white/60">
              Said the wrong thing? Just fix the transcript. AI syncs your voice and lips to make
              it look like that&rsquo;s what you said all along.
            </p>
